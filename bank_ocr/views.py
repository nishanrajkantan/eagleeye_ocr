...
class ResultView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        df_final2.to_csv(output_path + 'output2_' + 'combined' + '.csv', index=False)
        ...
        for index, rows in tqdm(df_final2.iterrows(), total=df_final2.shape[0]):
            ...
            post_data = {
                    "name": df_final2['ID TRANSAKSI'][index],
                    "geoLocation": "",
                    "ontology": "Transaction",
                    "imageUrl": "https://cdn3.iconfinder.com/data/icons/personal-business-finance/64/x-85-512.png"
            }
            ...
            post_data = {
                    "objectId": t_objectId,
                    "name": "Amount",
                    "value": str(df_final2['JUMLAH URUSNIAGA'][index])
                    }
            ...
            r = requests.post(url = Object_API_ENDPOINT, json = post_data)
            print("POST SENDER " + Object_API_ENDPOINT + " " +str(r.status_code))
            s_objectId = r.text
